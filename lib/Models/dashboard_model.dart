...
class DataDashboard {
  DataDashboard({
    ...
    List<DeliverymanPickupAssign>? deliverymanPickupAssign,
    ...
    _deliverymanPickupAssign = deliverymanPickupAssign;
  ...
  DataDashboard.fromJson(dynamic json) {
    ...
    if (json['deliveryman_pickup_assign'] != null) {
      _deliverymanPickupAssign = [];
      json['deliveryman_pickup_assign'].forEach((v) {
        _deliverymanPickupAssign?.add(DeliverymanPickupAssign.fromJson(v));
      });
    }
  ...
  List<DeliverymanPickupAssign>? _deliverymanPickupAssign;
  ...
  List<DeliverymanPickupAssign>? get deliverymanPickupAssign =>
      _deliverymanPickupAssign;

  List<DeliverymanReSchedule>? get deliverymanReSchedule =>
      _deliverymanReSchedule;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (_deliverymanAssign != null) {
      map['deliveryman_assign'] =
          _deliverymanAssign?.map((v) => v.toJson()).toList();
    }
    if (_deliverymanPickupAssign != null) {
      map['deliveryman_pickup_assign'] =
          _deliverymanPickupAssign?.map((v) => v.toJson()).toList();
    }
    if (_deliverymanReSchedule != null) {
      map['deliveryman_re_schedule'] =
          _deliverymanReSchedule?.map((v) => v.toJson()).toList();
    }
    if (_returnToCourier != null) {
      map['return_to_courier'] =
          _returnToCourier?.map((v) => v.toJson()).toList();
    }
    if (_delivered != null) {
...
class DeliverymanPickupAssign {
  ...
  DeliverymanPickupAssign.fromJson(dynamic json) {
    _id = json['id'];
    _trackingId = json['tracking_id'];
    _merchantId = int.parse(json['merchant_id'].toString());
    _merchantName = json['merchant_name'];
